...
int main(int argc, char **argv)
{
    ...
    std::string VertexPath = "/home/suyun/shenlan_course/shenlan_laser_slam/course6/LSSLAMProject/src/ls_slam/data/test_quadrat-v.dat";
    std::string EdgePath = "/home/suyun/shenlan_course/shenlan_laser_slam/course6/LSSLAMProject/src/ls_slam/data/test_quadrat-e.dat";

//    std::string VertexPath = "/home/suyun/shenlan_course/shenlan_laser_slam/course6/LSSLAMProject/src/ls_slam/data/intel-v.dat";
//    std::string EdgePath = "/home/suyun/shenlan_course/shenlan_laser_slam/course6/LSSLAMProject/src/ls_slam/data/intel-e.dat";
    ...
    for(int i = 0; i < maxIteration;i++)
    {
        ...
        {
            Vertexs[i] += Eigen::Vector3d(dx(i*3), dx(i*3+1), dx(i*3+2));
        }

        double tempError = ComputeError(Vertexs,Edges);
